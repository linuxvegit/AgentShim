...
(see §3 below for the trigger). Dropping the ticket without
`consume()` releases every slot — modulo the PR 2 implementation
asymmetry noted in §3 below.
...
Four PRs, each independently reviewable and bisect-friendly:
